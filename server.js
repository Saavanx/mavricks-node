...
const nttConfig = {
  merchantId: process.env.NTT_MERCHANT_ID || '317159',
  merchantPassword: process.env.NTT_MERCHANT_PASSWORD || 'Test@123',
  productId: process.env.NTT_PRODUCT_ID || 'NSE',
  authUrl: process.env.NTT_AUTH_URL || 'https://caller.atomtech.in/ots/aipay/auth',
  env: (process.env.NTT_ENV || 'UAT').toUpperCase(),
  cdnUrl: process.env.NTT_CDN_URL || 'https://pgtest.atomtech.in/staticdata/ots/js/atomcheckout.js',
  reqEncKey: process.env.NTT_REQ_ENC_KEY || 'A4476C2062FFA58980DC8F79EB6A799E',
  reqSalt: process.env.NTT_REQ_SALT || 'A4476C2062FFA58980DC8F79EB6A799E',
  resDecKey: process.env.NTT_RES_DEC_KEY || '75AEF0FA1B94B3C10D4F5B268F757F11',
  resSalt: process.env.NTT_RES_SALT || '75AEF0FA1B94B3C10D4F5B268F757F11',
  reqHashKey: process.env.NTT_REQ_HASH_KEY || 'KEY123657234',
  resHashKey: process.env.NTT_RES_HASH_KEY || 'KEYRESP123657234',
